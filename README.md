...
**Research Questions:**
- **RQ1:** How do Decision Tree, Random Forest, XGBoost, and LightGBM compare in accuracy, false-positive rate, training time, and computational overhead?
- **RQ2:** How does a three-stage feature selection pipeline affect detection accuracy and computational efficiency versus the full feature set?
- **RQ3:** How well does the best classifier generalise to an unseen DDoS attack type, and how much does fine-tuning with a small amount of target data improve detection?
